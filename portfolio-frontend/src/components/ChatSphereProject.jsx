  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-3xl font-bold mb-4 tracking-wide">ChatSphere</h2>
        <a
      ...
      <p className="text-md mb-4 leading-relaxed">
        ChatSphere is a fully functional chat application built using the MERN stack, providing real-time communication with WebRTC and Socket.io. Users can manage friends, create groups, and engage in video/voice calls seamlessly with a responsive UI.
      </p>
      ...
      <div className="flex flex-wrap gap-2">
        {['React', 'Node.js', 'Express.js', 'Tailwind CSS', 'WebRTC', 'Socket.io', 'MongoDB', 'GSAP', 'Framer Motion'].map(
          (tool) => (
            <span
              key={tool}
